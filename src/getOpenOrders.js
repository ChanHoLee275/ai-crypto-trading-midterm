...
async function getOpenOrders(signature, time, market) {
  const response = await fetch(process.env.API_URL + process.env.ORDERS_API + `?market=${market}`, {
    method: 'GET',
    headers: {
